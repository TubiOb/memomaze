...
const Sidebar = ({ openModal }) => {
  ...
  return (
    <aside className='h-[100svh] w-[50px] relative z-50 flex justify-center items-center'>
        <nav className='h-[100svh] w-[50px] flex flex-col flex-grow fixed px-2 py-2 items-center justify-between text-sm md:text-md shadow-md'>
