...
const Sidebar = ({ openModal }) => {
  ...
  return (
    <aside className='h-full shrink lg:h-screen lg:shrink-0 overflow-y-auto w-[50px] relative z-50 flex justify-center items-center border-r border-r-gray-300'>
        <nav className='h-full shrink lg:h-screen lg:shrink-0 overflow-y-auto w-[50px] flex flex-col flex-grow fixed px-2 py-1 items-center justify-between text-sm md:text-md'>
