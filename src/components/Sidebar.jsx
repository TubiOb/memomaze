...
const Sidebar = () => {
  ...
  return (
    <aside className='h-screen'>
        <nav className='h-screen py-3 grid grid-cols-1 bg-white border-r shadow-md justify-between'>
        {/* <button className='p-1.5 flex mt-1 ml-auto mr-[-15px] bg-white rounded-lg border border-blue-200 hover:bg-blue-100 hover:text-white hover:border-white'><LuPanelRightOpen /></button> */}
            ...
            <div className='flex flex-col px-2 py-2 text-sm md:text-md rounded-lg gap-6'>
            ...
            <div className='border-t flex flex-col items-center justify-center gap-1 p-1'>
