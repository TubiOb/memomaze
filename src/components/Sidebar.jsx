...
const Sidebar = ({ openModal }) => {
  ...
  return (
    <aside className='h-screen shrink lg:h-screen lg:shrink-0 w-[50px] relative z-50 flex justify-center items-center border-r border-r-gray-300'>
        <nav className='h-screen shrink lg:h-screen lg:shrink-0 w-[50px] flex flex-1 flex-col flex-grow fixed px-2 py-1 items-center justify-between text-sm md:text-md'>
