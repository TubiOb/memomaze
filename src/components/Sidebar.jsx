...
const Sidebar = () => {
  ...
  return (
    <aside className='h-screen'>
        <nav className='h-full flex flex-col items-center bg-white border-r shadow-md overflow-y-hidden'>
        {/* <button className='p-1.5 flex mt-1 ml-auto mr-[-15px] bg-white rounded-lg border border-blue-200 hover:bg-blue-100 hover:text-white hover:border-white'><LuPanelRightOpen /></button> */}
            ...
            <div className='flex flex-col px-2 py-2 justify-between text-sm bg-white h-full md:text-md'>
