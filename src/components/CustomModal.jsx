                ...
                <ModalContent>
                    ...
                    <ModalBody pb={6}>
                        {formFields.map((field, index) => (
                            <form onSubmit={(e) => e.preventDefault()} key={index} className='w-[95%] md:w-[90%] mt-2 flex flex-col mx-auto justify-between gap-4'>
                                        {field.type === 'input' ? (
                                            <React.Fragment>
                        ...
                        <ModalFooter>
                            <Button type='submit' colorScheme='teal' onClick={handleSubmit} mr={3}>Save</Button>
